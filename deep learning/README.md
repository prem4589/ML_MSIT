...
This is some records of Andrews' `deeplearning.ai` course from `Coursera`. I have uploaded my programming implement to this warehouse. There might be something wrong with my work, be free to email `premnukes@gmail.com`. And if you can push your right answer, that will be grateful.<br/>
...
-----
### Update Records
- Specialization 4 Done!　2018/11/13
- Move Course Records to Records.md　2018/11/14
- Add Expectation Maximization(EM) course links　2018/12/13
- Add a Chinese Version keras tutorial　2019/2/23
- Specialization 5 Done!　2019/3/8
- Add GANs repo  2019/5/13
